 ...
 * FIXME: Put this in ronin.h for convenience perhaps?
 */
...
extern void ta_commit_end(void);
extern void ta_begin_dlist(void *list, unsigned int size);
extern unsigned int ta_end_dlist(void);
extern void ta_begin_frame(void);
extern void ta_commit_frame(void);
extern void ta_rollback_frame(void);
extern void ta_init_renderstate(void);
extern void ta_enable_irq(void);
extern void ta_disable_irq(void);
...
#define TA_LIST_OPAQUEPOLY   1
#define TA_LIST_OPAQUEMOD    2
#define TA_LIST_TRANSPOLY    4
